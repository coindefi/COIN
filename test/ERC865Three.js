...
/******************************** Constants ************************************/
  ...
  describe('Constants', function () {
    ...
    it('should return true for unused hash', async function() {

      let validHash = await this.token.checkHash(this.owner, '0x00000001')
      validHash.should.be.equal(true)

    })

    it('should return false for used hash', async function() {

      await this.token.revokeHash('0x000000000000000000000000000000000000000000000000000001',{from:this.owner})
      let validHash = await this.token.checkHash(this.owner, '0x000000000000000000000000000000000000000000000000000001')
      validHash.should.be.equal(false)
